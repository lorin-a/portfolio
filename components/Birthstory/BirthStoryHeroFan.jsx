...
function Lead() {
  ...
  return (
    <div className={s.lead}>
      ...
      <p className={s.subhead}>Pregnancy and postpartum have strong support systems but giving birth is often a blur. <strong>How might we support parents in documenting and reflecting on their birth experience?</strong></p>
