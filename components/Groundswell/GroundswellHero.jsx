...
export default function GroundswellHero({ connectorsSvg }) {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // credit appears WITH the artwork (caption to the full-bleed image), leaves when it does
      ...
      // credit fades with the photos — once it's the abstract labelled diagram, there's no art to credit
      tl.to(creditRef.current, { autoAlpha: 0, duration: 0.5 }, 6.95)
