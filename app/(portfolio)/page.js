...
const PROJECTS = [
  {
    ...
    video: cloudVideo(GS_VIDEOS['gs-walkthrough-video'], 680),
    hoverVideo: cloudVideo(GS_VIDEOS['gs-card-flip'], 680),
  ...
  },
  {
    ...
    video: cloudVideo(HOME_VIDEOS['birthstory-default'], 1200),
    hoverVideo: cloudVideo(HOME_VIDEOS['birthstory-hover'], 1200),
  ...
  },
  {
    ...
    video: cloudVideo(HOME_VIDEOS['somebuddy-default'], 1200),
    hoverVideo: cloudVideo(HOME_VIDEOS['somebuddy-hover'], 1200),
  ...
  },
  {
    ...
    video: cloudVideo(HOME_VIDEOS['transition-design-default'], 1200),
    hoverVideo: cloudVideo(HOME_VIDEOS['transition-design-hover'], 1200),
  ...
  },
  {
    ...
    video: cloudVideo(HOME_VIDEOS['bridging-default'], 1200),
    hoverVideo: cloudVideo(HOME_VIDEOS['bridging-hover'], 1200),
