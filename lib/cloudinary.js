...
/** Cloudinary image URL with auto-format and auto-quality */
export function cloudImg(publicId) {
  return `${BASE}/image/upload/f_auto,q_auto/${publicId}`
}

/** Cloudinary video URL with auto-format and auto-quality */
export function cloudVideo(publicId) {
