...
/** Cloudinary video URL — forces mp4 for reliable autoplay across browsers.
 *  f_auto would pass .mov sources through as video/quicktime, which Chrome/FF won't autoplay. */
export function cloudVideo(publicId, width) {
  const transforms = width
    ? `f_mp4,q_auto,w_${width}`
    : 'f_mp4,q_auto'
